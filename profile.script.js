    ...
    let result = async () => {
      ...
      cardText.innerHTML = ` Hey there, I'm ${data.name}! My company's mission is <i>${data.company.catchPhrase}</i>. Below you can see my details & contact
          information`;
      ...
      listGroup.innerHTML = `
        ...
        <li class="list-group-item"><span>Website :</span> ${data.website}</li>
